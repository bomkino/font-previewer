...
- Designated later candidate: none.
...
No public release may be published without separate owner authorization, even when dry-run validation succeeds. The one-use authorization for `v0.1.0-rc.4` was exercised by publication run `33151987068` on 2026-08-28 and does not authorize a later tag or stable release.
