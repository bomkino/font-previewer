...
> **Current-status pointer — 2026-08-27**
>
...
- Latest published prerelease: `v0.1.0-rc.1`
- Current source: ahead of that release; preparing unreleased `v0.1.0-rc.2`
...
- optional Developer ID signing/notarisation path if ever adopted;
- explicit authorization for any future public release.
